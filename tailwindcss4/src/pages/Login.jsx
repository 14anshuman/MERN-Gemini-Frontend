...
const Login = () => {
    ...
    return (
            <div className='relative z-10 flex justify-center items-center min-h-screen w-full p-4'>
                ...
                >
                    <h2 className='text-3xl mb-6 text-white font-bold text-center'>Login</h2>
                    <div className='mb-6'>
                    ...
                    <button 
                        className={`w-full text-white py-3 px-4 rounded-lg bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] font-medium shadow-lg shadow-blue-500/20 ${btnLoading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        disabled={btnLoading}
                    >
